...
* Rename every file that has `XWikiAutomation` in its name, replacing `XWikiAutomation` with the module name.
* Replaces `XWikiAutomation` in every file with the module name.
